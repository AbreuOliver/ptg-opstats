	...
	<div class="grid w-full max-w-4xl grid-cols-1 gap-6 sm:grid-cols-2">
		<div class="flex-col">
			<a
				...
				class="relative flex h-40 items-center justify-center overflow-hidden rounded-xl border border-zinc-300 px-6 py-12 text-2xl font-semibold backdrop-blur-md transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--theme-color)] dark:border-0 dark:bg-zinc-900 dark:text-neutral-100 {data.allowsUrban
					? 'bg-white/70 text-neutral-900 hover:bg-white/80 dark:hover:bg-zinc-800'
		...
		<div class="flex-col">
			<a
				...
				class="relative flex h-40 items-center justify-center overflow-hidden rounded-xl border border-zinc-300 px-6 py-12 text-2xl font-semibold backdrop-blur-md transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--theme-color)] dark:border-0 dark:bg-zinc-900 dark:text-neutral-100 {data.allowsRural
					? 'bg-white/70 text-neutral-900 hover:bg-white/80 dark:hover:bg-zinc-800'
					: 'cursor-not-allowed bg-zinc-100 text-zinc-400 dark:bg-zinc-800 dark:text-zinc-500'}"
				data-sveltekit-preload-data="hover"
