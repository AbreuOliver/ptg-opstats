...
<CollapsibleSection {title} bind:open>
	<div class="grid w-full grid-cols-4 items-start gap-y-6 py-4 pr-4">
		<!-- WEEKDAY -->
		<div
			class="col-span-1 pr-8 text-right text-xl font-medium text-[var(--text)] dark:text-zinc-300"
		>
			Weekday
		</div>
		<div class="col-span-3 grid grid-cols-3 gap-4">
			...
			<div class="flex flex-col">
				<label for="weekdayPeakRoutes" class="mb-1 text-xl text-[var(--text-muted)]"
		...
		<div class="col-span-3 space-y-3">
			...
			{#if hasSaturday}
				<div class="grid grid-cols-3 gap-4">
					<div class="flex flex-col">
						<label for="saturdayStart" class="mb-1 text-xl text-[var(--text-muted)]"
							>Begin Time</label
						>
						<input
							id="saturdayStart"
					...
					<div class="flex flex-col">
						<label for="saturdayPeakRoutes" class="mb-1 text-xl text-[var(--text-muted)]"
							># of Peak Period Routes</label
						>
						<input
		...
		<div class="col-span-3 space-y-3">
			...
			{#if hasSunday}
				<div class="grid grid-cols-3 gap-4">
					...
					<div class="flex flex-col">
						<label for="sundayPeakRoutes" class="mb-1 text-xl text-[var(--text-muted)]"
							># of Peak Period Routes</label
						>
						<input
							id="sundayPeakRoutes"
